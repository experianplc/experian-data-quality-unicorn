(function () {
     ...
     */
    function UserState(_a) {
        var _b = _a.ui, ui = _b === void 0 ? null : _b, _c = _a.fn, fn = _c === void 0 ? null : _c, args = _a.args, _d = _a.self, self = _d === void 0 ? null : _d;
        this.ui = ui;
        this.fn = fn;
        this.args = args;
        this.self = self;
    ...
    UserState.prototype = {
        revertState: function () {
            ...
            var typedownPreviousSteps = document.getElementById('typedown-previous-steps');
