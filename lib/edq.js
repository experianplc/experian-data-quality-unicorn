...
(function () {
  ...
  function _emailValidateHelper() {
     ...
     * @returns {XMLHttpRequest}
     */
    this.emailValidate = function (_ref21) {
      var emailAddress = _ref21.emailAddress,
          _ref21$timeout = _ref21.timeout,
          timeout = _ref21$timeout === undefined ? 15 : _ref21$timeout,
          _ref21$verbose = _ref21.verbose,
          verbose = _ref21$verbose === undefined ? true : _ref21$verbose,
      ...
      return _this2.makeRequest(emailAddress, timeout, verbose, callback);
    };
  ...
  function _phoneValidateHelper(type) {
     ...
     * @returns {XMLHttpRequest}
     */
    this.reversePhoneAppend = function (_ref22) {
      var phoneNumber = _ref22.phoneNumber,
      ...
      return _this3.makeRequest(phoneNumber, callback);
    };
     ...
     * @returns {XMLHttpRequest}
     */
    this.globalPhoneValidate = function (_ref23) {
      var phoneNumber = _ref23.phoneNumber,
