...
(function () {
  ...
  function _globalIntuitiveHelpers() {
     ...
     * @returns {XMLHttpRequest}
     */
    this.search = function (_ref21) {
      var query = _ref21.query,
          country = _ref21.country,
          _ref21$take = _ref21.take,
          take = _ref21$take === undefined ? 7 : _ref21$take,
      ...
      return _this2.makeRequest(data, GLOBAL_INTUITIVE_URL + '/Search', callback);
    };
     ...
     * @returns {XMLHttpRequest}
     */
    this.formatByUrl = function (_ref22) {
      var formatUrl = _ref22.formatUrl,
      ...
      return _this2.makeRequest(data, formatUrl, callback);
    };
     ...
     * @returns {XMLHttpRequest}
     */
    this.format = function (_ref23) {
      var addressId = _ref23.addressId,
          country = _ref23.country,
          _ref23$take = _ref23.take,
          take = _ref23$take === undefined ? 7 : _ref23$take,
      ...
      return _this2.makeRequest(data, GLOBAL_INTUITIVE_AUTH_TOKEN + '/Format', callback);
    };
  ...
  function _emailValidateHelper() {
     ...
     * @returns {XMLHttpRequest}
     */
    this.emailValidate = function (_ref24) {
      var emailAddress = _ref24.emailAddress,
          _ref24$timeout = _ref24.timeout,
          timeout = _ref24$timeout === undefined ? 15 : _ref24$timeout,
          _ref24$verbose = _ref24.verbose,
          verbose = _ref24$verbose === undefined ? true : _ref24$verbose,
      ...
      return _this3.makeRequest(emailAddress, timeout, verbose, callback);
    };
  ...
  function _phoneValidateHelper(type) {
     ...
     * @returns {XMLHttpRequest}
     */
    this.reversePhoneAppend = function (_ref25) {
      var phoneNumber = _ref25.phoneNumber,
      ...
      return _this4.makeRequest(phoneNumber, callback);
    };
     ...
     * @returns {XMLHttpRequest}
     */
    this.globalPhoneValidate = function (_ref26) {
